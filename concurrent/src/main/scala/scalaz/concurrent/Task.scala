...
object Task {
  ...
  implicit val taskInstance: Nondeterminism[Task] with Catchable[Task] with BindRec[Task] with MonadError[Task, Throwable] =
    new Nondeterminism[Task] with Catchable[Task] with BindRec[Task] with MonadError[Task, Throwable] {
