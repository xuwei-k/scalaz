...
object TypeClass {
  ...
  lazy val bifoldable1 = TypeClass("Bifoldable1", *^*->*, extendsList = Seq(bifoldable))
  lazy val bitraverse1 = TypeClass("Bitraverse1", *^*->*, extendsList = Seq(bitraverse, bifoldable1))
