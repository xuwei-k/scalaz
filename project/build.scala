...
object build {
  ...
  lazy val standardSettings: Seq[Sett] = Seq[Sett](
    ...
    crossScalaVersions := Seq(Scala211, Scala212, "2.13.0-M4-pre-20d3c21"),
  ...
  lazy val core = crossProject(JSPlatform, JVMPlatform, NativePlatform).crossType(ScalazCrossType)
    ...
    .configure(
      _ dependsOn RootProject(uri("git://github.com/scala/scala-collection-compat#d4c8c3bf0caa0abb47ece93bee2bd4cae8e67846"))
    )
