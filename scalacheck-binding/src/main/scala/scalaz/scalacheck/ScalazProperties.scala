...
object ScalazProperties {
  ...
  object equal {
    ...
    def laws[A](implicit A: Equal[A], arb: Arbitrary[A]) =
  ...
  object order {
    ...
    def laws[A](implicit A: Order[A], arb: Arbitrary[A]) =
  ...
  object enum {
    ...
    def laws[A](implicit A: Enum[A], arb: Arbitrary[A]) =
  ...
  object semigroup {
    ...
    def laws[A](implicit A: Semigroup[A], eqa: Equal[A], arb: Arbitrary[A]) =
  ...
  object monoid {
    ...
    def laws[A](implicit A: Monoid[A], eqa: Equal[A], arb: Arbitrary[A]) =
  ...
  object apply {self =>
    ...
    def laws[F[_]](implicit F: Apply[F], af: Arbitrary[F[Int]],
                   aff: Arbitrary[F[Int => Int]], e: Equal[F[Int]]) =
  ...
  object cobind {
    ...
    def laws[F[_]](implicit a: Cobind[F], am: Arbitrary[F[Int]], e: Equal[F[Int]]) =
  ...
  object comonad {
    ...
    def laws[F[_]](implicit a: Comonad[F], am: Arbitrary[F[Int]],
                   af: Arbitrary[F[Int] => Int], e: Equal[F[Int]]) =
  ...
  object plus {
    ...
    def laws[F[_]](implicit F: Plus[F], afx: Arbitrary[F[Int]], ef: Equal[F[Int]]) =
  ...
  object plusEmpty {
    ...
    def laws[F[_]](implicit F: PlusEmpty[F], afx: Arbitrary[F[Int]], af: Arbitrary[Int => Int], ef: Equal[F[Int]]) =
  ...
  object isEmpty {
    ...
    def laws[F[_]](implicit F: IsEmpty[F], afx: Arbitrary[F[Int]], ef: Equal[F[Int]]) =
  ...
  object monadPlus {
    ...
    def laws[F[_]](implicit F: MonadPlus[F], afx: Arbitrary[F[Int]], afy: Arbitrary[F[Int => Int]], ef: Equal[F[Int]]) =
  ...
  object compose {
    ...
    def laws[=>:[_, _]](implicit C: Compose[=>:], AB: Arbitrary[Int =>: Int], E: Equal[Int =>: Int]) =
  ...
  object category {
    ...
    def laws[=>:[_, _]](implicit C: Category[=>:], AB: Arbitrary[Int =>: Int], E: Equal[Int =>: Int]) =
  ...
  object associative {
    ...
    def laws[=>:[_, _]](implicit F: Associative[=>:],
                        ...
                        el: Equal[(Int =>: Int) =>: Int], er: Equal[Int =>: (Int =>: Int)]) =
  ...
  object lens {
    ...
    def laws[A, B](l: Lens[A, B])(implicit A: Arbitrary[A], B: Arbitrary[B], EA: Equal[A], EB: Equal[B]) =
