...
object StrictTree extends StrictTreeInstances {
  ...
  private def hashCodeReducer[A](root: A)(subForest: mutable.Buffer[Int]): Int = {
...
final class StrictTreeUnzip[A1, A2](private val root: StrictTree[(A1, A2)]) extends AnyVal {
  private def unzipCombiner(rootLabel: (A1, A2))(accumulator: mutable.Buffer[(StrictTree[A1], StrictTree[A2])]): (StrictTree[A1], StrictTree[A2]) = {
