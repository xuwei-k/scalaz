...
trait ToMonadPlusOps extends ToMonadPlusOps0 with ToMonadZeroOps with ToApplicativePlusOps {
...
trait MonadPlusSyntax[F[_]] extends MonadZeroSyntax[F] with ApplicativePlusSyntax[F] {
