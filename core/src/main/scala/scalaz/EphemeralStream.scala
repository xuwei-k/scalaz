...
sealed abstract class EphemeralStreamInstances {
  // TODO more instances
  implicit val ephemeralStreamInstance = new MonadPlus[EphemeralStream] with Zip[EphemeralStream] with Traverse[EphemeralStream] {
    ...
    override def unzip[A, B](a: EphemeralStream[(A, B)]) = a.unzip
