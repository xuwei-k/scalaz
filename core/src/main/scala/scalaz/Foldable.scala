...
trait Foldable[F[_]]  { self =>
  ...
  def collapse3[G[_], H[_], X[_], A](x: F[G[H[A]]])(implicit
                                                   ...
                                                   , H: Foldable[H]
                                                   , A: ApplicativePlus[X]): X[A] = {
    implicit val Z = self compose G compose H
    Z.collapse(x)
  }
  ...
  def collapse4[G[_], H[_], I[_], X[_], A](x: F[G[H[I[A]]]])(implicit
                                                            ...
                                                            , I: Foldable[I]
                                                            , A: ApplicativePlus[X]): X[A] = {
    implicit val Z = self compose G compose H compose I
    Z.collapse(x)
  }
  ...
  def collapse5[G[_], H[_], I[_], J[_], X[_], A](x: F[G[H[I[J[A]]]]])(implicit
                                                                     ...
                                                                     , J: Foldable[J]
                                                                     , A: ApplicativePlus[X]): X[A] = {
    implicit val Z = self compose G compose H compose I compose J
    Z.collapse(x)
  }
  ...
  def collapse6[G[_], H[_], I[_], J[_], K[_], X[_], A](x: F[G[H[I[J[K[A]]]]]])(implicit
                                                                              ...
                                                                              , K: Foldable[K]
                                                                              , A: ApplicativePlus[X]): X[A] = {
    implicit val Z = self compose G compose H compose I compose J compose K
    Z.collapse(x)
  }
  ...
  def collapse7[G[_], H[_], I[_], J[_], K[_], L[_], X[_], A](x: F[G[H[I[J[K[L[A]]]]]]])(implicit
                                                                                       ...
                                                                                       , L: Foldable[L]
                                                                                       , A: ApplicativePlus[X]): X[A] = {
    implicit val Z = self compose G compose H compose I compose J compose K compose L
    Z.collapse(x)
  }
