...
trait EitherInstances extends EitherInstances0 {
  ...
  implicit def eitherFirstRightLInstance[L]: Monad[({type λ[α] = RightProjection[L, α] @@ First})#λ] = new AbstractMonad[({type λ[α] = RightProjection[L, α] @@ First})#λ] {
  ...
  implicit def eitherLastRightLInstance[L]: Monad[({type λ[α] = RightProjection[L, α] @@ Last})#λ] = new AbstractMonad[({type λ[α] = RightProjection[L, α] @@ Last})#λ] {
  ...
  implicit def eitherLeftRInstance[R]: Monad[({type λ[α] = LeftProjection[α, R]})#λ] = new AbstractMonad[({type λ[α] = LeftProjection[α, R]})#λ] {
  ...
  implicit def eitherFirstLeftRInstance[R]: Monad[({type λ[α] = LeftProjection[α, R] @@ First})#λ] = new AbstractMonad[({type λ[α] = LeftProjection[α, R] @@ First})#λ] {
  ...
  implicit def eitherLastLeftRInstance[R]: Monad[({type λ[α] = LeftProjection[α, R] @@ Last})#λ] = new AbstractMonad[({type λ[α] = LeftProjection[α, R] @@ Last})#λ] {
