...
trait IdInstances {
  ...
  val id: Traverse1[Id] with Each[Id] with Monad[Id] with Comonad[Id] with Cojoin[Id] with Distributive[Id] with ZipUnzip[Id] with Cozip[Id] =
    new Traverse1[Id] with Each[Id] with Monad[Id] with Comonad[Id] with Cobind.FromCojoin[Id] with Distributive[Id] with ZipUnzip[Id] with Cozip[Id] {
      def point[A](a: => A): A = a
