...
trait IdInstances {
  ...
  val id: Traverse1[Id @uncheckedVariance] with Each[Id @uncheckedVariance] with Monad[Id @uncheckedVariance] with Comonad[Id @uncheckedVariance] with Cojoin[Id @uncheckedVariance] with Distributive[Id @uncheckedVariance] with Zip[Id @uncheckedVariance] with Unzip[Id @uncheckedVariance] with Cozip[Id @uncheckedVariance] =
