...
object AlignTest extends Scalaprops {

  val F = Align[List]

  val pad = forAll{ (xs: List[Int], ys: List[Int]) =>
    val xys = F.pad(xs, ys)
  ...
  val alignB = forAll{ (xs: List[Int], ys: List[Int]) =>
  ...
  val alignThis = forAll{ (xs: List[Int], ys: List[Int]) =>
  ...
  val alignThat = forAll{ (xs: List[Int], ys: List[Int]) =>
  ...
  val alignBoth = forAll{ (xs: List[Int], ys: List[Int]) =>
